...
def save_feedback(name, email, feedback, ip_address, mac_address, visit_time, time_spent, visited_page):
    with open(FEEDBACK_FILE, 'a', newline='') as file:
        writer = csv.writer(file)
        writer.writerow([name, email, feedback, ip_address, mac_address, visit_time, time_spent, visited_page])
...
# Function to get the list of all visitors' feedback
